...
import { createBlog } from '../../actions/submission';
...
const CreateBlog = ({ router }) => {
    ...
    const publishBlog = e => {
        ...
        createBlog(formData, token).then(data => {
            if (data.error) {
                ...
                setValues({ ...values, title: '', error: '', success: `A new Image Repo titled "${data.title}" is created` });
                setBody('');
                setCategories([]);
                setTags([]);
            }
    ...
    const createBlogForm = () => {
        return (
            <form onSubmit={publishBlog} enctype="multipart/form-data">
                    ...
                    <div>
                        <div className="form-group pb-2">
                            ...
                            <label className="btn btn-outline-info">
                                ...
                                <input onChange={handleChange('photo')} type="file" name="avatar" />
                            </label>
                        </div>
                    </div>
                    <div>
